...
SELECT DISTINCT roots.Child_SchemaName, roots.Child_TableName, roots.FK_ColumnName, roots.Parent_SchemaName, roots.Parent_TableName
FROM fk_ref AS roots
ORDER BY roots.Child_SchemaName DESC, roots.Child_TableName ASC, roots.FK_ColumnName, roots.Parent_SchemaName, roots.Parent_TableName
