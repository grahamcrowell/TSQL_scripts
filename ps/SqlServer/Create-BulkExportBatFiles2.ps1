...
$ExportDatabaseName = "AP_WORKFLOW_DB"
...
foreach($SqlView in $SqlDatabase.Tables | Where-Object {$_.IsSystemObject -eq $false -and $_.Schema -ne "sys" -and $_.Name -eq "WF_REG_USERS"}) 
{
    # print to screen
